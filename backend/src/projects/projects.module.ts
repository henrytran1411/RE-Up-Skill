...
@Module({
  imports: [
    TypeOrmModule.forFeature([Project, ProjectSprint, ProjectContribution, ProjectNote, TaskRecord]),
    EmployeesModule,
  ],
  controllers: [ProjectsController],
  providers: [ProjectsService, ProjectSprintsService, ProjectContributionsService, ProjectNotesService],
  exports: [ProjectsService, ProjectSprintsService, ProjectContributionsService, ProjectNotesService],
})
